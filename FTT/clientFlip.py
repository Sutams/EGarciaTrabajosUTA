...
btn1 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked1)
btn2 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked2)
btn3 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked3)
btn4 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked4)
btn5 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked5)
btn6 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked6)
btn7 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked7)
btn8 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked8)
btn9 = Button(window, text=None, bg="white", fg="black", width=3, height=1, font=('Helvetica', '20'), command=clicked9)
